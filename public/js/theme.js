...
const THEME_DARK_DEFAULTS = {
  ...
  "--color-header-bg": "#040810",
  "--color-header-text": "#e0f0ff",
  "--color-bg": "#080c14",
  "--color-card": "rgba(12, 18, 32, 0.82)",
  "--color-card-border": "rgba(0, 229, 255, 0.14)",
  "--color-text": "#e0f0ff",
...
const DEFAULT_LABELS = {
  ...
  analytics_title: "تحليلات الأداء الشهرية",
  analytics_subtitle: "نظرة شاملة على أداء الفحص",
  analytics_pass_rate: "نسبة النجاح",
  analytics_total_reports: "إجمالي التقارير",
  analytics_total_items: "إجمالي البنود",
  analytics_total_failed: "بنود فاشلة",
  analytics_top_performers: "الأفضل أداءً",
  analytics_worst_performers: "يحتاج تحسين",
  analytics_section_detail: "تفصيل الأقسام",
  analytics_section: "القسم",
  analytics_items_count: "البنود",
  analytics_pass: "نجاح",
  analytics_fail: "فشل",
  analytics_rank: "#",
  analytics_export_csv: "تصدير CSV",
  analytics_export_pdf: "تصدير PDF",
  analytics_no_data: "لا توجد بيانات لهذا الشهر",
};
...
const DEFAULT_LABELS_EN = {
  ...
  analytics_title: "Monthly Performance Analytics",
  analytics_subtitle: "Comprehensive inspection performance overview",
  analytics_pass_rate: "Pass Rate",
  analytics_total_reports: "Total Reports",
  analytics_total_items: "Total Items",
  analytics_total_failed: "Failed Items",
  analytics_top_performers: "Top Performers",
  analytics_worst_performers: "Needs Improvement",
  analytics_section_detail: "Section Breakdown",
  analytics_section: "Section",
  analytics_items_count: "Items",
  analytics_pass: "Pass",
  analytics_fail: "Fail",
  analytics_rank: "#",
  analytics_export_csv: "Export CSV",
  analytics_export_pdf: "Export PDF",
  analytics_no_data: "No data for this month",
};
